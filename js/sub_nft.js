...
$(document).ready(function () {
  ...
  //  one page 取消 html更改文字
  if (window.matchMedia('(max-width: 991.98px)').matches) {
    pageable.destroy();
    $('.circle_group:first-child .content_thing').html('Picasso<br>經典IP元素授權');
    $('.circle_group:last-child .content_thing').html('數位生成<br>鑄造技術');
  }
});
